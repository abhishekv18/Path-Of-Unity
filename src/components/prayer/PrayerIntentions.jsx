...
const PrayerIntentions = ({ onCategoryChange, activePrayers }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 bg-white">
      {/* Header */}
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-yellow-500 bg-clip-text text-transparent mb-2">
          Prayer Intentions
        </h2>
        <p className="text-gray-600 text-lg">
          Filter prayers by their sacred purpose and intention
      ...
      <div className="mb-6">
        <button
          ...
          className={`
            w-full p-4 rounded-xl border-2 transition-all duration-300 transform
            ${selectedCategory === 'all' 
              ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white border-transparent shadow-lg scale-105' 
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className={`
                p-2 rounded-lg transition-colors duration-300
                ${selectedCategory === 'all' ? 'bg-white/20' : 'bg-blue-100'}
              `}>
                <Globe className={`w-6 h-6 ${selectedCategory === 'all' ? 'text-white' : 'text-blue-600'}`} />
              </div>
              <div>
                <h3 className={`font-semibold text-lg ${selectedCategory === 'all' ? 'text-white' : 'text-gray-800'}`}>
                  All Prayers
              ...
              {isSelected && (
                <div className="absolute top-2 right-2">
                  <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center shadow-sm">
                    <div className="w-3 h-3 bg-gradient-to-r from-blue-600 to-yellow-500 rounded-full" />
                  </div>
                </div>
              )}
            </button>
      ...
      {selectedCategory !== 'all' && (
        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-yellow-50 rounded-lg border border-blue-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-gradient-to-r from-blue-600 to-yellow-500 rounded-full animate-pulse" />
              <span className="text-gray-700 font-medium">
                Showing prayers for: {categories.find(c => c.id === selectedCategory)?.name}
              </span>
            </div>
