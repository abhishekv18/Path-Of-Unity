...
// import { Calendar, Heart, Users, ArrowRight, Sparkles, Clock, Sun } from 'lucide-react';
...
//   const handleDonate = () => {
//     // PayPal donation logic would go here
//     window.open('#', '_blank');
//   };

//   return (
//     <section className="relative py-20 overflow-hidden bg-gradient-to-br from-amber-50 via-white to-blue-50">
//       {/* Subtle Divine Light Rays */}
//       <div className="absolute inset-0">
//         <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-amber-200 via-transparent to-transparent opacity-30 transform rotate-12"></div>
//         <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-blue-200 via-transparent to-transparent opacity-30 transform -rotate-12"></div>
//         <div className="absolute top-0 left-1/2 w-px h-full bg-gradient-to-b from-purple-200 via-transparent to-transparent opacity-30"></div>
//       </div>
...
//               <Sun className="w-16 h-16 text-amber-500 animate-spin" style={{ animationDuration: '20s' }} />
//               <div className="absolute inset-0 w-16 h-16 border-2 border-amber-300 rounded-full animate-ping opacity-20"></div>
//             </div>
//           </div>
//           <h2 className="text-4xl md:text-5xl font-light text-gray-700 mb-6 leading-tight">
//             <span className="block text-2xl md:text-3xl text-gray-500 mb-2 font-normal">Join Our Sacred</span>
...
//         {/* Temple Countdown - Clean & Spiritual */}
//         <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 mb-16 border border-amber-100 shadow-lg max-w-4xl mx-auto">
//           <div className="flex items-center justify-center mb-8">
//             <Clock className="w-6 h-6 text-amber-600 mr-3" />
//             <h3 className="text-2xl md:text-3xl font-light text-gray-700">Sacred Temple Opening</h3>
//           </div>
...
//               >
//                 <div className="bg-gradient-to-br from-white to-amber-50 rounded-xl p-6 border border-amber-100 shadow-sm hover:shadow-md transition-all duration-300 group-hover:scale-105">
//                   <div className="text-3xl md:text-4xl font-light text-gray-700 mb-2">{value}</div>
//                   <div className="text-amber-600 text-sm font-medium uppercase tracking-wider">{unit}</div>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//           {/* Join Community */}
//           <div className="group bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-blue-100 hover:bg-white/80 transition-all duration-500 transform hover:scale-105 hover:shadow-xl">
//             <div className="flex justify-center mb-6">
//               <div className="relative">
//                 <Users className="w-12 h-12 text-blue-500 group-hover:scale-110 transition-transform duration-300" />
...
//               </div>
//             </div>
//             <h3 className="text-xl font-medium text-gray-700 mb-4 text-center">Sacred Community</h3>
//             <p className="text-gray-600 mb-8 text-center font-light leading-relaxed">
//               Connect with kindred spirits on their spiritual journey. Share wisdom, find support, and grow together in divine love.
//             </p>
//             <Link to='/contact'>
//             <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium py-3 px-6 rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center group shadow-md">
//               Begin Journey
...
//           {/* Prayer Wall */}
//           <div className="group bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-purple-100 hover:bg-white/80 transition-all duration-500 transform hover:scale-105 hover:shadow-xl">
//             <div className="flex justify-center mb-6">
//               <div className="relative">
//                 <Heart className="w-12 h-12 text-purple-500 group-hover:scale-110 transition-transform duration-300" />
//                 <div className="absolute -inset-2 bg-purple-100 rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-300"></div>
//               </div>
//             </div>
//             <h3 className="text-xl font-medium text-gray-700 mb-4 text-center">Light of Prayer</h3>
//             <p className="text-gray-600 mb-8 text-center font-light leading-relaxed">
//               Kindle a sacred flame of hope. Share prayers, light virtual candles, and join in collective meditation.
//             </p>
//             <Link to='/prayers'>
//             <button className="w-full bg-gradient-to-r from-purple-500 to-purple-600 text-white font-medium py-3 px-6 rounded-xl hover:from-purple-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center group shadow-md">
//               Light Candle
//               <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300" />
//             </button>
//             </Link>
...
//           {/* Support Mission */}
//           <div className="group bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-amber-100 hover:bg-white/80 transition-all duration-500 transform hover:scale-105 hover:shadow-xl">
//             <div className="flex justify-center mb-6">
//               <div className="relative">
//                 <Calendar className="w-12 h-12 text-amber-500 group-hover:scale-110 transition-transform duration-300" />
//                 <div className="absolute -inset-2 bg-amber-100 rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-300"></div>
//               </div>
//             </div>
//             <h3 className="text-xl font-medium text-gray-700 mb-4 text-center">Sacred Offering</h3>
//             <p className="text-gray-600 mb-8 text-center font-light leading-relaxed">
//               Support our divine mission to build the Unity Temple—a sanctuary where all faiths unite in harmony.
//             </p>
//             <button
//               onClick={handleDonate}
//               className="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-white font-medium py-3 px-6 rounded-xl hover:from-amber-600 hover:to-amber-700 transition-all duration-300 flex items-center justify-center group shadow-md"
//             >
//               Give Blessing
//               <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300" />
//             </button>
...
//           <div className="bg-gradient-to-r from-amber-50 via-white to-blue-50 rounded-3xl p-12 border border-amber-100 shadow-lg">
//             <div className="text-center">
//               <div className="flex justify-center mb-6">
//                 <Sparkles className="w-8 h-8 text-amber-500 animate-pulse" />
//               </div>
//               <h3 className="text-3xl md:text-4xl font-light text-gray-700 mb-6">
//                 In Unity, We Find
...
//                 <Link to='/contact'>
//                 <button className="bg-gradient-to-r from-amber-600 to-purple-600 text-white font-medium py-4 px-8 rounded-xl hover:from-amber-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 flex items-center shadow-lg">
//                   Embrace Your Path
