...
//           }}
//         >
//           {i % 3 === 0 && <Sparkles className="w-6 h-6 text-divine-gold" />}
//           {i % 3 === 1 && <Star className="w-4 h-4 text-unity-purple" />}
//           {i % 3 === 2 && <Sun className="w-5 h-5 text-peace-blue" />}
//         </div>
//       ))}
//     </div>
//   );
...
//     <section 
//       ref={sectionRef}
//       className="relative py-20 md:py-32 bg-gradient-to-br from-soft-cream via-white to-peace-blue/10 overflow-hidden"
//     >
//       {/* Floating Elements */}
//       <FloatingElements />
...
//           style={{
//             backgroundImage: `radial-gradient(circle at 25% 75%, rgba(212,175,55,0.3) 0%, transparent 50%), 
...
//               <span className="text-divine-gold font-semibold uppercase tracking-wider text-sm">Our Sacred Mission</span>
//               <Shield className="w-6 h-6 text-divine-gold" />
//             </div>
            
//             <h2 className="font-spiritual text-4xl md:text-6xl font-bold mb-6">
//               <span className="bg-gradient-to-r from-divine-gold via-unity-purple to-peace-blue bg-clip-text text-transparent">
...
//               <div
//                 key={card.id}
//                 className={`group relative bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer transform hover:scale-105 border border-white/20 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}
//                 style={{ 
...
//                       <IconComponent className={`w-8 h-8 text-${card.color} group-hover:animate-pulse`} />
//                     </div>
//                   </div>
...
//                       <Sparkles className="w-6 h-6 text-divine-gold animate-spin" />
//                     </div>
//                   )}
//                 </div>
...
//                   <h3 className="font-spiritual text-xl font-bold mb-4 text-deep-navy group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-divine-gold group-hover:to-unity-purple group-hover:bg-clip-text transition-all duration-300">
//                     {card.title}
//                   </h3>
//                   <p className="text-deep-navy/70 leading-relaxed text-sm group-hover:text-deep-navy/80 transition-colors duration-300">
//                     {card.description}
//                   </p>
//                 </div>
...
//           <div className="bg-gradient-to-r from-divine-gold/10 via-unity-purple/10 to-peace-blue/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/30 shadow-xl">
//             <h3 className="font-spiritual text-2xl md:text-3xl font-bold mb-4 text-deep-navy">
//               Join Our Sacred Journey
//             </h3>
//             <p className="text-deep-navy/70 mb-8 max-w-2xl mx-auto leading-relaxed">
...
//                 <Link to="/contact">
//               <button className="group relative px-8 py-4 bg-gradient-to-r from-divine-gold to-unity-purple text-white font-semibold rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl">
//                 <div className="absolute inset-0 bg-gradient-to-r from-unity-purple to-peace-blue opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
...
//               </Link>
//               <Link to="/teachings">
//               <button className="group px-8 py-4 bg-white/50 backdrop-blur-sm text-deep-navy font-semibold rounded-full border border-white/40 transition-all duration-300 hover:scale-105 hover:bg-white/70">
...
//       <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-divine-gold via-unity-purple to-peace-blue opacity-30"></div>
//     </section>
//   );
// };
