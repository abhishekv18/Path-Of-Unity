...
const Footer = () => {
  ...
  const footerSections = {
    about: {
      ...
      links: [
        { name: "Sacred Origins", href: "/about", icon: Scroll },
        { name: "Holy Founders", href: "/about#founders", icon: Cross },
        { name: "Divine Vision", href: "/about#vision", icon: Star },
        { name: "Interfaith Harmony", href: "/about#interfaith", icon: Sparkles }
      ]
    },
    resources: {
      title: "Sacred Resources",
      ...
      links: [
        { name: "Daily Scriptures", href: "/teachings", icon: Scroll },
        { name: "Prayer Sanctuary", href: "/prayers", icon: Cross },
        { name: "Wisdom Pearls", href: "/quotes", icon: Sparkles },
        { name: "Holy Texts", href: "/teachings#texts", icon: Book }
      ]
    },
    community: {
      title: "Holy Community",
  ...
  return (
    <>
      <footer className="relative bg-white text-gray-800 border-t-2 border-blue-600">
        {/* Header Border */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h3 className="font-serif text-xl font-bold text-blue-800">
                      International Laity Association
                    </h3>
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-2">
                      <div className="p-1.5 bg-blue-100 rounded-md">
                        <contact.icon className="w-3.5 h-3.5 text-blue-600" />
                      </div>
              ...
              {Object.entries(footerSections).map(([key, section]) => {
                ...
                return (
                  <div key={key}>
                    <div className="flex items-center space-x-2 mb-4">
                      <SectionIcon className="w-4 h-4 text-yellow-500" />
                      <h4 className="font-serif text-lg font-semibold text-blue-800">
                        {section.title}
                      </h4>
                    </div>
                      ...
                      {section.links.map((link) => {
                        ...
                        return (
                          <li key={link.name}>
                            <a
                              href={link.href}
                              className="flex items-center space-x-2 text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm py-1"
                            >
          ...
          <div className="border-t border-blue-200 py-8">
            <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                <span className="text-gray-700 font-serif">Follow Our Journey:</span>
                  ...
                  {socialLinks.map((social) => {
                    ...
                    return (
                      <a
                        key={social.name}
                        href={social.href}
                        className="w-10 h-10 bg-blue-100 border border-blue-200 rounded-lg flex items-center justify-center hover:bg-blue-200 transition-colors duration-200"
                        aria-label={social.name}
                      >
              ...
              <div className="flex items-center space-x-4">
                <span className="text-gray-700 font-serif">Receive Blessings:</span>
                <div className="relative">
                  <input
                    type="email"
                    placeholder="Your email"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    className="px-4 py-2 bg-white border border-blue-300 text-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm w-48"
                  />
                  <button 
                    onClick={handleBlessing}
                    className="ml-2 px-4 py-2 bg-yellow-400 text-blue-900 rounded-lg hover:bg-yellow-500 transition-colors duration-200 text-sm font-medium"
                  >
                   Blessings
                  </button>
                </div>
          ...
          {/* Bottom Bar */}
          <div className="border-t border-blue-200 py-4">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
              <div className="flex items-center space-x-2 text-gray-600 text-sm">
                <span>© {currentYear} International Laity Association.</span>
                <div className="flex items-center space-x-1">
                  <span>Made with</span>
      ...
      {showBlessing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="max-w-md w-full bg-white rounded-xl shadow-2xl border-2 border-blue-200">
            <div className="h-1 bg-gradient-to-r from-blue-600 via-yellow-400 to-blue-600"></div>
            ...
            <div className="p-6 text-center">
              ...
              <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <Sparkles className="w-6 h-6 text-white" />
              </div>
              
              <h3 className="text-xl font-serif font-bold text-blue-800 mb-4">
                Divine Blessing
              </h3>
              
              <p className="text-gray-700 italic font-serif mb-4 border-y border-blue-200 py-3">
                "{randomBlessing}"
              </p>
              
              <p className="text-sm text-gray-600 mb-4">
                Thank you! Your email <span className="font-medium text-blue-800">{email}</span> has been added to our mailing list.
              </p>
              
              <button
                onClick={closeBlessing}
                className="px-6 py-2 bg-gradient-to-r from-blue-500 to-yellow-500 text-white rounded-lg hover:opacity-90 transition-opacity duration-200"
              >
                Accept Blessing
              </button>
            </div>
